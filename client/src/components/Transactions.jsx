...
const TransactionCard = ({addressTo, addressFrom, timestamp, message, keyword, amount, url}) => {
    ...
    return (
        <div className="bg-[#181918] m-4 flex flex-1 
                        2xl:min-2-[450px] 2xl:max-2-[500px]
                        sm:min-2-[270px] sm:max-2-[300px]
        ...
        <div className="flex flex-col item-center w-full mt-3">
            ...
            <img src = {gifUrl || url}
                ...
                <div className="items:center justfy-centers  bg-black p-2 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
                    <p className="text-[#37c7da] fron-bold">
                        {timestamp}
                    </p>
                </div>
        </div>
